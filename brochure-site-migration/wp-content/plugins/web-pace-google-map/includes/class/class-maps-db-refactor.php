 ...
 *
 * Class Webpace_Maps_DB_Refactor
 */
class Webpace_Maps_DB_Refactor {
	...
	public static function init() {
		...
		$old_api_key = get_option( 'webpace_map_api_key', null );

		if ( ! is_null( $old_api_key ) && $old_api_key != '' ) {

			delete_option( 'webpace_map_api_key' );

			update_option( 'webpace_maps_api_key', $old_api_key );
		...
		$new_maps_count = count( Webpace_Maps_Query::get_maps() );
	...
	public static function refactor_markers() {
		...
		foreach ( $markers as $marker ) {
			...
			$new_marker = new Webpace_Maps_Marker();
	...
	public static function refactor_polygons() {
		...
		foreach ( $polygons as $polygon ) {
			...
			$new_polygon = new Webpace_Maps_Polygon();
	...
	public static function refactor_polylines() {
		...
		foreach ( $polylines as $polyline ) {
			...
			$new_polyline = new Webpace_Maps_Polyline();
	...
	public static function refactor_circles() {
		...
		foreach ( $circles as $circle ) {
			...
			$new_circle = new Webpace_Maps_Circle();
	...
	public static function refactor_directions() {
		...
		foreach ( $directions as $direction ) {
			...
			$new_direction = new Webpace_Maps_Direction();
