jQuery(document).ready(function(){
    ...
    jQuery("#locator_edit_submit").on("click",function(){
        ...
        var data = {
            action: "webpace_maps_edit_locator",
    ...
    jQuery("#locator_submit").on("click",function(){
        ...
        var data = {
            action: "webpace_maps_save_new_locator",
            nonce : locatorSaveL10n.nonce,
            map_id: map_id,
            name: name,
            locatorLat: locatorLat,
            ...
            if (response.success) {
                ...
                if (jQuery(".empty_locator").html() != undefined) {
                    jQuery(".empty_locator").after("<ul>" +
                        ...
                        "<form class='edit_list_delete_form' method='post' action='admin.php?page=webpacegooglemaps_main&task=edit_cat&id='" + map_id + "'>" +
