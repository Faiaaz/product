jQuery(document).ready(function () {
    ...
    jQuery('.webpace_maps_delete_map_from_list').on('click',function(){
    ...
    jQuery(".close_free_banner").click(function(){
        ...
        webpaceMapsSetCookie( 'webpaceMapsFreeBannerShow', 'no', {expires:86400} );
    });
    function webpaceMapsSetCookie(name, value, options) {
        options = options || {};
