...
<div class="clear-float" style="<?php echo $locStyles; ?>">
    <?php if($map->get_locator_enabled()){
        Webpace_Maps_Template_Loader::get_template( 'frontend/store-locator.php', array( 'map' => $map ) );
    } ?>
</div>
<div class="webpace_google_map_container">
    <div id="webpace_google_map_<?php echo $i; ?>" data-map_id="<?php echo $map->get_id(); ?>"
         class="webpace_google_map" style="<?php echo $styles; ?>"
