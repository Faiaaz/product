...
<li class="editing_section">
    <div class="editing_heading">
        ...
        <?php _e( 'Polygons', 'webpace_map' ); ?>
        <div class="help">?
            <div class="help-block">
                <span class="pnt"></span>
                <p><?php _e( 'Bounded highlighted area on the map, showing the specific range, limited with geometric figure. Right click on the map to add point. Hold pressed and drag to move it. Left click to remove it.', 'webpace_map' ); ?></p>
            </div>
        </div>
    ...
    <div class="edit_content hide">
        <div id="g_map_polygone_options">
            <form action="" method="post">
                <a id="polygon_add_button" class="add_button clear" href="#">+<?php _e( 'Add New Polygon', 'webpace_map' ); ?></a>
                <div class="hidden_edit_content hide">
                    <a href="#" id="back_polygone" class="cancel left">◄ <?php _e( 'Back', 'webpace_map' ); ?></a>
                    <ul>
                        <li class="has_background">
                            <label for="polygone_name"><?php _e( 'Name', 'webpace_map' ); ?></label>
                            <input type="text" name="polygone_name" id="polygone_name"/>
                        </li>
                        <li class="description_container">
                            <label for="polygone_coords">data</label>
                            <textarea id="polygone_coords" class="polycoords" name="polygone_coords" readonly="readonly" placeholder="<?php _e( 'Right click on the map to add point. Hold pressed and drag to move it. Left click to remove it.', 'webpace_map' ); ?>"></textarea>
                        </li>
                        <li>
                            <label for="polygone_line_opacity"><?php _e( 'Line Transparency', 'webpace_map' ); ?></label>
                        ...
                        <li class="has_background">
                            <label for="polygone_line_color"><?php _e( 'Line Color', 'webpace_map' ); ?></label>
                            <input type="text" class="jscolor polygone_options_input" name="polygone_line_color" id="polygone_line_color" value="FF0F0F"/>
                        </li>
                        <li>
                            <label for="polygone_line_width"><?php _e( 'Line Width', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px;">
                        ...
                        <li class="has_background">
                            <label for="polygone_fill_opacity"><?php _e( 'Fill Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li>
                            <label for="polygone_fill_color"><?php _e( 'Fill Color', 'webpace_map' ); ?></label>
                            <input type="text" name="polygone_fill_color" id="polygone_fill_color"
                                   class="jscolor polygone_options_input" value="5DFF0D"/>
                        </li>
                        <li class="pro">
                            <label for="polygone_url"><?php _e( 'Link', 'webpace_map' ); ?></label>
                            <input disabled type="text" name="polygone_url" id="polygone_url" placeholder="http://"/>
                        </li>
                        <li class="pro">
                            <label for="hover_polygone_fill_opacity"><?php _e( 'On-Hover Fill Transparency', 'webpace_map' ); ?></label>
                        ...
                        <li class="pro">
                            <label for="hover_polygone_fill_color"><?php _e( 'On-Hover Fill Color', 'webpace_map' ); ?></label>
                        ...
                        <li class="pro">
                            <label for="hover_polygone_line_opacity"><?php _e( 'On-Hover Line Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="pro">
                            <label for="hover_polygone_line_color"><?php _e( 'On-Hover Line Color', 'webpace_map' ); ?></label>
                    ...
                    <div>
                        ...
                        <a href="#" id="cancel_polygone" class="cancel"><?php _e( 'Cancel', 'webpace_map' ); ?></a>
                    </div>
                </div>
            </form>
            <div id="polygone_edit_exist_section">
                ...
                if( $polygons ){
                            ...
                            <li class="edit_list" data-list_id="<?php echo $polygon->get_id(); ?>">
                                ...
                                <div class="edit_polygone_list_delete edit_list_delete">
                                    <form class="edit_list_delete_form" method="post" action="">
                                        ...
                                        <input type="hidden" class="edit_list_delete_table" value="webpace_maps_polygons"/>
                    ...
                    echo "<p class='empty_polygon'>".__( 'You have 0 polygones on this map', 'webpace_map' ) ."</p>";
                }
                ?>
            </div>
            <form action="" method="post">
                ...
                <div class="update_list_item hide">
                    <a href="#" id="back_edit_polygone" class="cancel left">◄ <?php _e( 'Back', 'webpace_map' ); ?></a>
                    <ul>
                        <li class="has_background">
                            <label for="polygone_edit_name"><?php _e( 'Name', 'webpace_map' ); ?></label>
                        ...
                        <li class="description_container">
                            ...
                            <textarea id="polygone_edit_coords" class="polycoords" name="polygone_edit_coords" readonly="readonly"
                                      placeholder="<?php _e( 'Right click on the map to add point. Hold pressed and drag to move it. Left click to remove it.', 'webpace_map' ); ?>"></textarea>
                        </li>
                        <li>
                            <label for="polygone_edit_line_opacity"><?php _e( 'Line Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="has_background">
                            <label for="polygone_edit_line_color"><?php _e( 'Line Color', 'webpace_map' ); ?></label>
                            <input type="text" class="jscolor polygone_edit_options_input" name="polygone_edit_line_color"
                                   id="polygone_edit_line_color" value=""/>
                        </li>
                        <li>
                            <label for="polygone_edit_line_width"><?php _e( 'Line Width', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="has_background">
                            <label for="polygone_edit_fill_opacity"><?php _e( 'Fill Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li>
                            <label for="polygone_edit_fill_color"><?php _e( 'Fill Color', 'webpace_map' ); ?></label>
                            <input type="text" name="polygone_edit_fill_color" id="polygone_edit_fill_color"
                                   class="jscolor polygone_edit_options_input" value=""/>
                        </li>
                        <li class="pro">
                            <label for="polygone_edit_url"><?php _e( 'Link', 'webpace_map' ); ?></label>
                            <input disabled type="text" name="polygone_edit_url" id="polygone_edit_url" placeholder="http://"/>
                        </li>
                        <li class="pro">
                            <label for="hover_polygone_edit_fill_opacity"><?php _e( 'On-Hover Fill Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="pro">
                            <label for="hover_polygone_edit_fill_color"><?php _e( 'On-Hover Fill Color', 'webpace_map' ); ?></label>
                        ...
                        <li class="pro">
                            <label for="hover_polygone_edit_line_opacity"><?php _e( 'On-Hover Line Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="pro">
                            <label for="hover_polygone_edit_line_color"><?php _e( 'On-Hover Line Color', 'webpace_map' ); ?></label>
                    ...
                    <div>
                        ...
                        <input type="submit" class="button-primary" name="polygone_edit_submit" id="polygone_edit_submit"
                               value="<?php _e( 'Save', 'webpace_map' ); ?>"/>
                        <a href="#" id="cancel_edit_polygone" class="cancel"><?php _e( 'Cancel', 'webpace_map' ); ?></a>
                    </div>
                </div>
            </form>
        </div>
