...
<li class="editing_section">
    <div class="editing_heading">
        ...
        <?php _e( 'Circles', 'webpace_map' ); ?>
        <div class="help">?
            <div class="help-block">
                <span class="pnt"></span>
                <p><?php _e( 'Round area, showing the specific range. Right click on map wherever you need to place the circle’s center. Hold pressed and drag to move it', 'webpace_map' ); ?></p>
            </div>
        </div>
    ...
    <div class="edit_content hide">
        <div id="g_map_circle_options">
            <form action="" method="post">
                <a id="circle_add_button" class="add_button" href="#">+<?php _e( 'Add New Circles', 'webpace_map' ); ?></a>
                <div class="hidden_edit_content hide">
                    <a href="#" id="back_circle" class="cancel left">◄ <?php _e( 'Back', 'webpace_map' ); ?></a>
                    <ul>
                        <li class="has_background">
                            <label for="circle_name"><?php _e( 'Name', 'webpace_map' ); ?></label>
                            <input type="text" id="circle_name" name="circle_name" class="circle_options_input"/>
                        </li>
                        <li>
                            <label for="circle_center_addr"><?php _e( 'Center Address', 'webpace_map' ); ?></label>
                            <input type="text" class="circle_options_input" id="circle_center_addr" name="circle_center_addr"/>
                        </li>
                        <li class="has_background">
                            <label for="circle_center_lat"><?php _e( 'Center Latitude', 'webpace_map' ); ?></label>
                            <input type="text" class="circle_options_input" id="circle_center_lat" name="circle_center_lat"/>
                        </li>
                        <li>
                            <label for="circle_center_lng"><?php _e( 'Center Longitude', 'webpace_map' ); ?></label>
                            <input type="text" class="circle_options_input" id="circle_center_lng" name="circle_center_lng"/>
                        </li>

                        <li class="has_background">
                            <label><?php _e( 'Show Marker?', 'webpace_map' ); ?></label>
                            <label class="radio_label" for="circle_marker_show"><?php _e( 'YES', 'webpace_map' ); ?></label>
                            <input type="radio" class="radio circle_marker_show" id="circle_marker_show" name="circle_marker_show"
                                   value="1"/>
                            <label class="radio_label" for="circle_marker_show"><?php _e( 'NO', 'webpace_map' ); ?></label>
                            <input type="radio" class="radio circle_marker_show" id="circle_marker_not_show" name="circle_marker_show"
                                   value="0" checked/>
                        </li>
                        <li>
                            <label for="circle_radius"><?php _e( 'Radius(meter)', 'webpace_map' ); ?></label>
                            <input type="number" class="circle_options_input" id="circle_radius" name="circle_radius" value="50000"/>
                        </li>
                        <li class="has_background">
                            <label for="circle_line_width"><?php _e( 'Line Width', 'webpace_map' ); ?></label>
                        ...
                        <li>
                            <label for="circle_line_color"><?php _e( 'Line Color', 'webpace_map' ); ?></label>
                            <input type="text" class="jscolor circle_options_input" id="circle_line_color" name="circle_line_color"
                                   value="FF2B39"/>
                        </li>
                        <li class="has_background">
                            <label for="circle_line_opacity"><?php _e( 'Line Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li>
                            <label for="circle_fill_color"><?php _e( 'Fill Color', 'webpace_map' ); ?></label>
                            <input type="text" class="jscolor circle_options_input" id="circle_fill_color" name="circle_fill_color"
                                   value="4FFF72"/>
                        </li>
                        <li class="has_background">
                            <label for="circle_fill_opacity"><?php _e( 'Fill Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px;">
                        ...
                        <li class="pro">
                            <label for="hover_circle_fill_color"><?php _e( 'On-Hover Fill Color', 'webpace_map' ); ?></label>
                        ...
                        <li class="pro">
                            <label for="hover_circle_fill_opacity"><?php _e( 'On-Hover Fill Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px;">
                        ...
                        <li class="pro">
                            <label for="hover_circle_line_color"><?php _e( 'On-Hover Line Color', 'webpace_map' ); ?></label>
                        ...
                        <li class="pro">
                            <label for="hover_circle_line_opacity"><?php _e( 'On-Hover Line Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                    ...
                    <div>
                        ...
                        <input type="submit" class="button-primary" id="circle_submit" name="circle_submit" value="<?php _e( 'Save', 'webpace_map' ); ?>"/>

                        <a href="#" id="cancel_circle" class="cancel"><?php _e( 'Cancel', 'webpace_map' ); ?></a>
                    </div>
                </div>
            </form>
            <div id="circle_edit_exist_section">
                            ...
                            <div class="edit_circle_list_delete edit_list_delete">
                                <form class="edit_list_delete_form" method="post" action="">
                                    ...
                                    <input type="hidden" class="edit_list_delete_type" name="edit_list_delete_type"
                                           value="circle"/>
                                    <input type="hidden" class="edit_list_delete_table" value="webpace_maps_circles"/>
                ...
                <?php
                    ...
                    echo "<p class='empty_circle'>".__('you have 0 circles on this map','webpace_map')."</p>";
                }
                ?>
            </div>
            <form action="" method="post">
                ...
                <div class="update_list_item hide">
                    <a href="#" id="back_edit_circle" class="cancel left">◄ <?php _e( 'Back', 'webpace_map' ); ?></a>
                    <ul>
                        <li class="has_background">
                            <label for="circle_edit_name"><?php _e( 'Name', 'webpace_map' ); ?></label>
                            <input type="text" id="circle_edit_name" name="circle_edit_name" class="circle_edit_options_input"/>
                        </li>
                        <li>
                            <label for="circle_edit_center_addr"><?php _e( 'Center Address', 'webpace_map' ); ?></label>
                            <input type="text" class="circle_edit_options_input" id="circle_edit_center_addr"
                                   name="circle_edit_center_addr"/>
                        </li>
                        <li class="has_background">
                            <label for="circle_edit_center_lat"><?php _e( 'Center Latitude', 'webpace_map' ); ?></label>
                            <input type="text" class="circle_edit_options_input" id="circle_edit_center_lat"
                                   name="circle_edit_center_lat"/>
                        </li>
                        <li>
                            <label for="circle_edit_center_lng"><?php _e( 'Center Longitude', 'webpace_map' ); ?></label>
                        ...
                        <li class="has_background">
                            <label><?php _e( 'Show Marker?', 'webpace_map' ); ?></label>
                            <label class="radio_label" for="circle_edit_marker_show_true"><?php _e( 'YES', 'webpace_map' ); ?></label>
                            <input type="radio" class="radio circle_edit_marker_show" name="circle_edit_marker_show"
                                   id="circle_edit_marker_show_true" value="1">
                            <label class="radio_label" for="circle_edit_marker_show_false"><?php _e( 'NO', 'webpace_map' ); ?></label>
                            <input type="radio" class="radio circle_edit_marker_show" name="circle_edit_marker_show"
                                   id="circle_edit_marker_show_false" value="0">
                        </li>
                        <li>
                            <label for="circle_edit_radius"><?php _e( 'Radius(meter)', 'webpace_map' ); ?></label>
                            <input type="number" class="circle_edit_options_input" id="circle_edit_radius" name="circle_edit_radius"
                                   value="1000000"/>
                        </li>
                        <li class="has_background">
                            <label for="circle_edit_line_width"><?php _e( 'Line Width', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li>
                            <label for="circle_edit_line_color"><?php _e( 'Line Color', 'webpace_map' ); ?></label>
                        ...
                        <li class="has_background">
                            <label for="circle_edit_line_opacity"><?php _e( 'Line Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li>
                            <label for="circle_edit_fill_color"><?php _e( 'Fill Color', 'webpace_map' ); ?></label>
                        ...
                        <li class="has_background">
                            <label for="circle_edit_fill_opacity"><?php _e( 'Fill Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="pro">
                            <label for="hover_circle_edit_fill_color"><?php _e( 'On-Hover Fill Color', 'webpace_map' ); ?></label>
                        ...
                        <li class="pro">
                            <label for="hover_circle_edit_fill_opacity"><?php _e( 'On-Hover Fill Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px;">
                        ...
                        <li class="pro">
                            <label for="hover_circle_edit_line_color"><?php _e( 'On-Hover Line Color', 'webpace_map' ); ?></label>
                        ...
                        <li class="pro">
                            <label for="hover_circle_edit_line_opacity"><?php _e( 'On-Hover Line Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                    ...
                    <div>
                        <span class="spinner"></span>
                        <input type="submit" class="button-primary" id="circle_edit_submit" name="circle_edit_submit" value="<?php _e( 'Save', 'webpace_map' ); ?>"/>

                        <a href="#" id="cancel_edit_circle" class="cancel"><?php _e( 'Cancel', 'webpace_map' ); ?></a>
                    </div>
                </div>
            </form>
        </div>
