...
<li class="editing_section">
    <div class="editing_heading">
        ...
        <?php _e( 'Polylines', 'webpace_map' ); ?>
        <div class="help">?
            <div class="help-block">
                <span class="pnt"></span>
                <p><?php _e( 'Continuous line composed of one or more line segments, which creates specific track. Right click on the map to add point. Hold pressed and drag to move it. Left click to remove it.', 'webpace_map' ); ?></p>
            </div>
        </div>
    ...
    <div class="edit_content hide">
        <div id="g_map_polyline_options">
            <form action="" method="post">
                <a id="polyline_add_button" class="add_button" href="#">+<?php _e( 'Add New Polyline', 'webpace_map' ); ?></a>
                <div class="hidden_edit_content hide">
                    <a href="#" id="back_polyline" class="cancel left">◄ <?php _e( 'Back', 'webpace_map' ); ?></a>
                    <ul>
                        <li>
                            <label for="polyline_name"><?php _e( 'Name', 'webpace_map' ); ?></label>
                            <input type="text" id="polyline_name" name="polyline_name"/>
                        </li>
                        <li>
                            <label for="polyline_coords"><?php _e( 'data', 'webpace_map' ); ?></label>
                        ...
                        <li>
                            <label for="polyline_line_opacity"><?php _e( 'Line Transparency', 'webpace_map' ); ?></label>
                        ...
                        <li>
                            <label for="polyline_line_color"><?php _e( 'Line Color', 'webpace_map' ); ?></label>
                            <input type="text" class="jscolor polyline_options_input" name="polyline_line_color"
                                   id="polyline_line_color" value="18A326"/>
                        </li>
                        <li>
                            <label for="polyline_line_width"><?php _e( 'Line Width', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="pro">
                            <label for="hover_polyline_line_color"><?php _e( 'On-Hover Line Color', 'webpace_map' ); ?></label>
                        ...
                        <li class="pro">
                            <label for="hover_polyline_line_opacity"><?php _e( 'On-Hover Line Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                    ...
                    <div>
                        ...
                        <input type="submit" class="button-primary" id="polyline_submit" name="polyline_submit" value="<?php _e( 'Save', 'webpace_map' ); ?>"/>
                        <a href="#" id="cancel_polyline" class="cancel"><?php _e( 'Cancel', 'webpace_map' ); ?></a>
                    </div>
                </div>
            </form>
            <div id="polyline_edit_exist_section">
                ...
                if( $polylines ){
                                ...
                                <div class="edit_polyline_list_delete edit_list_delete">
                                    <form class="edit_list_delete_form" method="post" action="">
                                        ...
                                        <input type="hidden" class="edit_list_delete_type" name="edit_list_delete_type"
                                               value="polyline"/>
                                        <input type="hidden" class="edit_list_delete_table" value="webpace_maps_polylines"/>
                    ...
                    echo "<p class='empty_polyline'>".__('You have 0 polylines on this map','webpace_map')."</p>";
                }
                ?>
            </div>
            <form action="" method="post">
                ...
                <div class="update_list_item hide">
                    <a href="#" id="back_edit_polyline" class="cancel left">◄ <?php _e( 'Back', 'webpace_map' ); ?></a>
                    <ul>
                        <li>
                            <label for="polyline_edit_name"><?php _e( 'Name', 'webpace_map' ); ?></label>
                            <input type="text" id="polyline_edit_name" name="polyline_edit_name"/>
                        </li>
                        <li>
                            <label for="polyline_edit_coords"><?php _e( 'data', 'webpace_map' ); ?></label>
                            <textarea id="polyline_edit_coords" class="polycoords" name="polyline_edit_coords" readonly="readonly"
                                      placeholder="<?php _e( 'Right click on the map to add point. Hold pressed and drag to move it. Left click to remove it.', 'webpace_map' ); ?>"></textarea>
                        </li>
                        <li>
                            <label for="polyline_edit_line_opacity"><?php _e( 'Line Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li>
                            <label for="polyline_edit_line_color"><?php _e( 'Line Color', 'webpace_map' ); ?></label>
                        ...
                        <li>
                            <label for="polyline_edit_line_width"><?php _e( 'Line Width', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                        ...
                        <li class="pro">
                            <label for="hover_polyline_edit_line_color"><?php _e( 'On-Hover Line Color', 'webpace_map' ); ?></label>
                        ...
                        <li class="pro">
                            <label for="hover_polyline_edit_line_opacity"><?php _e( 'On-Hover Line Transparency', 'webpace_map' ); ?></label>
                            <div class="slider-container" style="float:left; width:55%; height:25px; ">
                    ...
                    <div>
                        <span class="spinner"></span>
                        <input type="submit" class="button-primary" id="polyline_edit_submit" name="polyline_edit_submit" value="<?php _e( 'Save', 'webpace_map' ); ?>"/>
                        <a href="#" id="cancel_edit_polyline" class="cancel"><?php _e( 'Cancel', 'webpace_map' ); ?></a>
                    </div>
                </div>
            </form>
        </div>
