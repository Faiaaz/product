...
<li class="editing_section">
    <div class="editing_heading">
        ...
        <div class="help">?
            <div class="help-block">
                <span class="pnt"></span>
                <p><?php _e( 'Highlighted road areas on map, highlight the roads and real-time traffic on them, make bicycle road highlighted on your map, transit roads, which connects cities etc...', 'webpace_map' ); ?></p>
            </div>
        </div>
    ...
    <div class="edit_content map_options hide">
        <form action="" method="post">
            <ul>
                <li class="pro">
                    <label for="traffic_layer_enable"><?php _e( 'Enable Traffic Layer', 'webpace_map' ); ?></label>
                ...
                <li class="pro">
                    <label for="bicycling_layer_enable"><?php _e( 'Enable Bicycling Layer', 'webpace_map' ); ?></label>
                ...
                <li class="pro">
                    <label for="transit_layer_enable"><?php _e( 'Enable Transit layer', 'webpace_map' ); ?></label>
            ...
            <input disabled type="submit" class="button-primary" id="submit_layers" name="submit_layers" value="<?php _e( 'Save', 'webpace_map' ); ?>"/>
        </form>
    </div>
</li>
