...
?>
<div id="g_map_canvas" class="g_map"
     style="height:<?php echo $map->get_height(); ?>px;width:<?php echo $map->get_width() / 2 ?>%;border-radius:<?php echo $map->get_border_radius(); ?>px;position:relative !important"></div>
