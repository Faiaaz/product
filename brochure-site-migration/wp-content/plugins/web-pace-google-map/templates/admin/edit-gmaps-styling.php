...
<li class="editing_section">
    <div class="editing_heading">
        ...
        <?php _e( 'Map Styling', 'webpace_map' ); ?>
        <div class="help">?
            <div class="help-block">
                <span class="pnt"></span>
                <p><?php _e( 'Choose some color/tone for the current map', 'webpace_map' ); ?></p>
            </div>
        </div>
    ...
    <div class="edit_content map_options hide">
        <form action="" method="post">
            <ul>
                <li class="pro">
                    <label for="g_map_styling_hue"><?php _e( 'Hue(color)', 'webpace_map' ); ?></label>
                ...
                <li class="pro">
                    <label for="g_map_styling_lightness"><?php _e( 'Lightness', 'webpace_map' ); ?></label>
                ...
                <li class="pro">
                    <label for="g_map_styling_saturation"><?php _e( 'Saturation', 'webpace_map' ); ?></label>
                    <div class="slider-container" style="float:left; width:55%; height:25px; ">
                ...
                <li class="pro">
                    <label for="g_map_styling_gamma"><?php _e( 'Gamma', 'webpace_map' ); ?></label>
                    <div class="slider-container" style="float:left; width:55%; height:25px; ">
            ...
            <input disabled type="submit" class="button-primary" id="styling_submit" name="styling_submit" value="<?php _e( 'Save', 'webpace_map' ); ?>"/>
            <input disabled type="button" class="button cancel_button" id="styling_set_default" value="<?php _e( 'Default', 'webpace_map' ); ?>"/>
        </form>
    </div>
</li>
