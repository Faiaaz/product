...
<li class="markers_editor editing_section">
	<div class="editing_heading">
		...
		<?php _e( 'Markers', 'webpace_map' ); ?>
		<div class="help">?
			<div class="help-block">
				<span class="pnt"></span>
				<p><?php _e( 'A marker identifies a location on a map. Right-Click on the map to add a Marker. Hold pressed and drag to move it', 'webpace_map' ); ?></p>
			</div>
		</div>
	...
	<div class="edit_content hide" id="g_map_marker_options">
		<form action="" method="post">
			<a class="add_button" id="marker_add_button" href="#">+<?php _e( 'Add New Marker', 'webpace_map' ); ?></a>
			<div class="hidden_edit_content hide">
				<a href="#" id="back_marker" class="cancel left">◄ <?php _e( 'Back', 'webpace_map' ); ?></a>
				<ul>
					<li>
						<label for="marker_location"><?php _e( 'Address', 'webpace_map' ); ?></label>
						<input type="text" id="marker_location" name="marker_location"/>
					</li>
					<li>
						<label for="marker_location_lat"><?php _e( 'Latitude', 'webpace_map' ); ?></label>
						<input type="text" id="marker_location_lat" name="marker_location_lat"/>
					</li>
					<li>
						<label for="marker_location_lng"><?php _e( 'Longitude', 'webpace_map' ); ?> </label>
						<input type="text" id="marker_location_lng" name="marker_location_lng"/>
					</li>
					<li>
						<label for="marker_animation"><?php _e( 'Animation', 'webpace_map' ); ?></label>
					...
					<li>
						<label for="marker_title"><?php _e( 'Title', 'webpace_map' ); ?></label>
						<input type="text" id="marker_title" name="marker_title"/>
					</li>
					<li class="description_container">
						<label for="marker_description"><?php _e( 'Description', 'webpace_map' ); ?><span class="pro_desc"><a href="http://webpace.com/google-map" target="_blank"><?php _e( 'Go Pro', 'webpace_map' ); ?></a>  <?php _e( 'to enable HTML in description', 'webpace_map' ); ?></span></label>
						<textarea class="description" id="marker_description" name="marker_description"></textarea>
					</li>
					<li><?php _e( 'Choose Marker Icon', 'webpace_map' ); ?></li>
					<li class="marker_image_choose">
						<ul>
							...
							$icons = Webpace_Maps_Marker::get_default_icons();
					...
					<li class="pro">
						...
						<select name="marker_image_size" id="marker_image_size" disabled>
							<?php
							$sizes = Webpace_Maps_Marker::get_default_icon_sizes();
					...
					<li class="pro">
						<label for="marker_pic"><?php _e( 'Custom Marker Icon', 'webpace_map' ); ?></label>
					...
					<div>
						...
						<input type="submit" class="button-primary" id="marker_submit" name="marker_submit" value="<?php _e( 'Save', 'webpace_map' ); ?>" style="width:23%"/>
		...
		<div id="markers_edit_exist_section">
			...
			if( $markers ) {
						...
						<li class="edit_list" data-list_id="<?php echo $marker->get_id(); ?>">
							...
							<div class="edit_marker_list_delete edit_list_delete">
								<form class="edit_list_delete_form" method="post" action="">
									...
									<input type="hidden" class="edit_list_delete_table" value="webpace_maps_markers"/>
				...
				echo "<p class='empty_marker'>".__('You have 0 markers','webpace_map')."</p>";
			}
		...
		<form action="" method="post">
			...
			<div class="update_list_item hide">
				<a href="#" id="back_edit_marker" class="cancel left">◄ <?php _e( 'Back', 'webpace_map' ); ?></a>
				<ul>
					<li>
						<label for="marker_edit_location"><?php _e( 'Address', 'webpace_map' ); ?></label>
						<input type="text" id="marker_edit_location" name="marker_edit_location"/>
					</li>
					<li>
						<label for="marker_edit_location_lat"><?php _e( 'Latitude', 'webpace_map' ); ?></label>
						<input type="text" id="marker_edit_location_lat" name="marker_edit_location_lat"/>
					</li>
					<li>
						<label for="marker_edit_location_lng"><?php _e( 'Longitude', 'webpace_map' ); ?></label>
						<input type="text" id="marker_edit_location_lng" name="marker_edit_location_lng"/>
					</li>
					<li>
						<label for="marker_edit_animation"><?php _e( 'Animation', 'webpace_map' ); ?></label>
						<select id="marker_edit_animation" name="marker_edit_animation">
							<option selected="selected" value="NONE"><?php _e( 'None', 'webpace_map' ); ?></option>
							<option value="BOUNCE">Bounce</option>
							<option value="DROP">Drop</option>
						</select>
					</li>
					<li>
						<label for="marker_edit_title"><?php _e( 'Title', 'webpace_map' ); ?></label>
						<input type="text" id="marker_edit_title" name="marker_edit_title"/>
					</li>
					<li class="description_container">
						<label for="marker_edit_description"><?php _e( 'Description', 'webpace_map' ); ?><span class="pro_desc"><a href="http://webpace.com/google-map" target="_blank"><?php _e( 'Go Pro', 'webpace_map' ); ?></a>  <?php _e( 'to enable HTML in description', 'webpace_map' ); ?></span></label>
					...
					<li class="pro">
						<label for="marker_edit_image_size"><?php _e( 'Size of Icon', 'webpace_map' ); ?></label>
					...
					<li class="pro">
						<label for="marker_edit_pic"><?php _e( 'Custom Marker Icon', 'webpace_map' ); ?></label>
